<?php
// $Id: template.php,v 1.1.2.1 2009/06/22 04:36:03 agileware Exp $
...
function burnt_rubber_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function burnt_rubber_menu_local_task($link, $active = FALSE) {
...
function burnt_rubber_breadcrumb($breadcrumb) {
...
function burnt_rubber_comment_wrapper($content, $type = null) {
  static $node_type;
  if (isset($type)) {
    $node_type = $type;
  }
...
function burnt_rubber_menu_local_tasks() {
  $output = '';
 ...
 * @ingroup themeable
 */
function burnt_rubber_button($element) {
 ...
 */
function burnt_rubber_img_assist_page($content, $attributes = NULL) {
