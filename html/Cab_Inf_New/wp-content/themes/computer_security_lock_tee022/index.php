...
<?php
$prev_link = get_previous_posts_link(__('Noticias Recentes >>', 'kubrick'));
$next_link = get_next_posts_link(__('&laquo;&laquo; Noticias Antigas, 'kubrick'));
?>
...
<?php if (!is_page()) : ?>
<?php ob_start(); ?>
<?php printf(__('Postado em', 'kubrick'), get_the_category_list(', ')); ?>
<?php $icons[] = ob_get_clean(); ?>
<?php endif; ?>
