...
<h2 class="pagetitle"><?php printf(__('Arquivos para &#8216;%s&#8217;', 'kubrick'), single_cat_title('', false)); ?></h2>
<?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
<h2 class="pagetitle"><?php printf(__('Posts Tagged &#8216;%s&#8217;', 'kubrick'), single_tag_title('', false) ); ?></h2>
<?php /* If this is a daily archive */ } elseif (is_day()) { ?>
<h2 class="pagetitle"><?php printf(_c('Aquivos para %s|Daily archive page', 'kubrick'), get_the_time(__('jS f, Y', 'kubrick'))); ?></h2>
...
<h2 class="pagetitle"><?php _e('Arquivos do Autor', 'kubrick'); ?></h2>
<?php /* If this is a paged archive */ } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
<h2 class="pagetitle"><?php _e('Arquivos do Blog', 'kubrick'); ?></h2>
<?php } ?>

<?php
$prev_link = get_previous_posts_link(__('Novas Noticias &raquo;&raquo;', 'kubrick'));
$next_link = get_next_posts_link(__('&laquo;&laquo; Antigas Noticias', 'kubrick'));
?>
...
<span class="PostHeader"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Link para %s', 'kubrick'), the_title_attribute('echo=0')); ?>">
<?php the_title(); ?>
</a></span>
</h2>
<?php $icons = array(); ?>
<?php if (!is_page()) : ?>
<?php ob_start(); ?>
<?php the_time(__('jS F, Y', 'kubrick')) ?>
<?php $icons[] = ob_get_clean(); ?>
<?php endif; ?>
<?php if (!is_page()) : ?>
<?php ob_start(); ?>
<?php _e('Autor', 'kubrick'); ?>: <a href="#" title="<?php _e('Autor', 'kubrick'); ?>"><?php the_author() ?></a>
<?php $icons[] = ob_get_clean(); ?>
<?php endif; ?>
...
<?php endif; ?>
<div class="PostContent">
<?php if (is_search()) the_excerpt(true); else the_content(__('Read the rest of this entry &raquo;', 'kubrick')); ?>
...
<?php if (!is_page()) : ?>
<?php ob_start(); ?>
<?php printf(__('Postado em %s', 'kubrick'), get_the_category_list(', ')); ?>
<?php $icons[] = ob_get_clean(); ?>
<?php endif; ?>
