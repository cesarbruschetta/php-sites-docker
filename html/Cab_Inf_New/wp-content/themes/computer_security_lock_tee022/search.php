...
<div class="PostContent">
		...
		<h2><?php _e('Resultado de Busca', 'kubrick'); ?></h2>

		<?php
		$prev_link = get_previous_posts_link(__('Nova Pagina &raquo;&raquo;', 'kubrick'));
		$next_link = get_next_posts_link(__('&laquo;&laquo; Pagina Antiga', 'kubrick'));
		?>
...
<div class="PostContent">
		...
		<h2 class="center"><?php _e('Nenuma pagina encontrada, tente mudar a palavra chave!!', 'kubrick'); ?></h2>
