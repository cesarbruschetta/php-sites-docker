...
$query_Rs_ListaPaginas = "SELECT pag_id, pag_nome, pag_status, pag_data FROM sm_paginas ORDER BY pag_id ASC";
$Rs_ListaPaginas = mysql_query($query_Rs_ListaPaginas, $speedyam) or die(mysql_error());
$row_Rs_ListaPaginas = mysql_fetch_assoc($Rs_ListaPaginas);
$totalRows_Rs_ListaPaginas = mysql_num_rows($Rs_ListaPaginas);
?>
...
<div id="editar">  <h1>Editar ou Excluir Conteudo do Site</h1>
  ...
  <p>&nbsp;</p>
<p>&nbsp;</p>  
  <table id="Paginas" border="0" align="center">
    <tr>
      <th width="149">ID da Pagina</th>
      <th width="170">Nome da Pagina</th>
      <th width="172">Status da Pagina</th>
      <th width="162">Data da Cria&ccedil;&atilde;o</th>
      <th colspan="2">Op&ccedil;&atilde;o</th>
      </tr>
    <?php do { ?>
      <tr>
        <td><?php echo $row_Rs_ListaPaginas['pag_id']; ?></td>
        <td><?php echo $row_Rs_ListaPaginas['pag_nome']; ?></td>
        <td><?php if ($row_Rs_ListaPaginas['pag_status'] == 1) { 
			 echo "On-Line"; } else if ($row_Rs_ListaPaginas['pag_status'] == 2) {  
			 echo "Off-Line";}  ?></td>
        <td><?php echo date('d/m/Y', strtotime($row_Rs_ListaPaginas['pag_data']));  ?></td>
        <td width="24"><a href="editar_pag.php?id=<?php echo $row_Rs_ListaPaginas['pag_id']; ?>&KeepThis=true&TB_iframe=true&height=600&width=850" class="thickbox" ><img src="../imagens/b_edit.png" alt="Editar Pagina" width="16" height="16" border="0" title="Editar Pagina" /></a></td>
        <td width="19"><a href="excluir_pag.php?id=<?php echo $row_Rs_ListaPaginas['pag_id']; ?>&KeepThis=true&TB_iframe=true&height=200&width=400" class="thickbox" ><img src="../imagens/b_drop.png" alt="Excluir Pagina" width="16" height="16" border="0" title="Excluir Pagina"/></a></td>
      </tr>
      <?php } while ($row_Rs_ListaPaginas = mysql_fetch_assoc($Rs_ListaPaginas)); ?>
  </table>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($Rs_ListaPaginas);
?>
