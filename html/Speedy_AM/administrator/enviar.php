...
<title>Speedy AutoMotors - Enviando E-mail</title>
<!-- InstanceEndEditable -->
...
<table width="0" border="0" align="center">
  ...
  <h1>Envio de Emails</h1>
   <p id="se">Obrigado pelo contato.<br /><br />    </p>
    <p id="se">
    <?php 
...
$mail->AddAddress("speedyautomotors@bol.com.br","Speedy AutoMotors");
...
{    echo "Sua mensagem foi enviada com sucesso !!! ";
	 echo "<br />";
	 echo "<br />";
	 echo "Em breve voce recebera uma resposta pelo seu contato";
}
else
...
<p id="se"><a href="home.php">&lt;&lt; Voltar para Home</a> </p>
