...
mysql_select_db($database_speedyam, $speedyam);
$query_Rs_conteudo = sprintf("SELECT pag_id, pag_status, pag_titulo, pag_conteudo FROM sm_paginas WHERE pag_id = %s", GetSQLValueString($colname_Rs_conteudo, "int"));
$Rs_conteudo = mysql_query($query_Rs_conteudo, $speedyam) or die(mysql_error());
...
<h1><?php echo $row_Rs_conteudo['pag_titulo']; ?></h1>
<p><?php echo $row_Rs_conteudo['pag_conteudo']; ?></p>
      <!-- InstanceEndEditable -->
