...
#horiznav{height:67px; z-index:500; float:none}
#horiznav ul{list-style:none; line-height:67px; padding-top:0px}
#horiznav ul li{position:relative; margin:0}
#horiznav a{text-transform:uppercase; display:block; cursor:pointer; height:67px; padding:0px 0px 0px 25px; margin:0px 0px 0px 0px; font:bold 10px/67px Tahoma}
#horiznav li a:hover{height:67px}
...
#horiznav_d{height:67px; position:relative; display:block; padding:0px; margin:0px; overflow:hidden; background-color:#dbdbdb}
#horiznav_d a{white-space:nowrap; display:block; float:left; text-transform:uppercase; cursor:pointer; height:67px; padding:0px 25px 0px 25px; margin:0px 0px 0px 0px; font:bold 10px/67px Tahoma}
#horiznav_d ul{margin:0; padding-top:0px; line-height:67px; float:left}
#horiznav_d ul ul ul{left:-20000px}
#horiznav_d li{padding:0; margin:0 0px 0 0; float:left; display:block}
#horiznav_d li ul{display:none; margin:0 auto; padding:0; position:absolute; top:67px; height:67px; overflow:hidden; left:0; width:100%}
...
#horiznav_d li a, #horiznav_d li .separator{font:bold 10px/67px Tahoma; text-transform:uppercase}
...
.menu{padding:0; text-align:left; margin-left:-20px; margin-right:-8px}
#mainlevel li, 
.menu li, 
