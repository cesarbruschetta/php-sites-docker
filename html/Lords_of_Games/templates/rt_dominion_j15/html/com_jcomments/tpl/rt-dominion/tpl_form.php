...
?>
<h2 class="title comments-title"><?php echo JText::_('LEAVE A REPLY'); ?></h2>
...
<div id="comments-form-buttons">
	<div id="comments-form-send"><a href="#" class="readon" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><span><?php echo JText::_('FORM_SEND'); ?></span></a></div>
	<div id="comments-form-cancel" style="display:none;"><a href="#" class="readon" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><span><?php echo JText::_('FORM_CANCEL'); ?></span></a></div>
