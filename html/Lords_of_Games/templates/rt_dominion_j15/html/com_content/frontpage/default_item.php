...
<div class="rt-article <?php if ($this->item->state == 0) echo 'unpublished' ?>">
	...
	<div class="rt-article-bg">
		...
		<?php /** Begin Article Title **/ if ($canEdit || $this->item->params->get('show_title') || ($this->item->params->get('show_pdf_icon') || $this->item->params->get('show_print_icon') || $this->item->params->get('show_email_icon'))) : ?>
