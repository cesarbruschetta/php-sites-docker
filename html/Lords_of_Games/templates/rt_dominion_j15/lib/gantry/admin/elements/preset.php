...
class JElementPreset extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if (!defined('GANTRY_PRESET')) {
			...
			$document->addScript('../templates/'.$this->template.'/lib/gantry/admin/widgets/preset/js/preset.js');
			$document->addScript('../templates/'.$this->template.'/lib/gantry/admin/widgets/preset/js/preset-saver.js');
