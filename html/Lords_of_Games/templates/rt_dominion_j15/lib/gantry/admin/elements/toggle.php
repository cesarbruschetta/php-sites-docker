	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name='params')
	{
		...
		if (!defined('GANTRY_TOGGLE')) {
            ...
            $document->addScript('../templates/'.$this->template.'/lib/gantry/admin/widgets/toggle/js/touch.js');
            $document->addScript('../templates/'.$this->template.'/lib/gantry/admin/widgets/toggle/js/toggle.js');
