...
img.border{border:1px solid #2a2a2a; background:#212121}
.special{background:#303030; border:1px solid #2b2a2a}
...
.highlight{border-bottom:1px dashed #212121; background:#3c3c3c}
pre, .code{border-left:5px solid #2a2a2a !Important; border-right:1px solid #2a2a2a !Important; border-top:1px solid #2a2a2a !Important; border-bottom:1px solid #2a2a2a !Important; background:#212121 !Important}
div.blockquote{border:1px solid #2a2a2a; background:#212121 url(../images/typ/qlg.gif) no-repeat 0px 2px  !Important}
div.blockquote blockquote{background:url(../images/typ/qrg.gif) no-repeat right bottom}
.dropcap{color:#2a2a2a; font-family:Georgia,Times,serif}
p.sticky{border-right:1px solid #2a2a2a; border-top:1px solid #2a2a2a; border-left:5px solid #2a2a2a; border-bottom:1px solid #2a2a2a; background:#212121 url(../images/typ/sticky.gif) no-repeat left center}
p.pin{border-right:1px solid #2a2a2a; border-top:1px solid #2a2a2a; border-left:5px solid #2a2a2a; border-bottom:1px solid #2a2a2a; background:#212121 url(../images/typ/pin.gif) no-repeat left center}
p.clip{border-right:1px solid #2a2a2a; border-top:1px solid #2a2a2a; border-left:5px solid #2a2a2a; border-bottom:1px solid #2a2a2a; background:#212121 url(../images/typ/clip.gif) no-repeat left center}
p.down{border-right:1px solid #2a2a2a; border-top:1px solid #2a2a2a; border-left:5px solid #2a2a2a; border-bottom:1px solid #2a2a2a; background:#212121 url(../images/typ/down.gif) no-repeat left center}
.bignumber{color:#2a2a2a; background-position:left top}
body ul.star li, 
body li.star{background:url(../images/typ/star.gif)   no-repeat 0 1px}
body ul.video li, 
body li.video{background:url(../images/typ/video.gif) no-repeat 0px  0px}
