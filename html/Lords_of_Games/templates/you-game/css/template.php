...
body{text-align:center; padding:0; margin:0px 0 0px 0; color:#808080;  background-color:#FFF; font-family:"Trebuchet MS",sans-serif; font-style:normal; font-weight:normal; letter-spacing:normal; line-height:1.45em}

a:focus{outline:0px}
focus, .button{outline:0px}
...
.article_separator{display:block; height:1px; margin:3px 0; clear:both; border-bottom:1px solid #1c1c1c}
.inputbox{margin-top:5px}
img a, img{border:0; padding:0}
.imagemargin_left{margin:0 0 0 5px}
.imagemargin_right{margin:5px 5px 0 0px}
.contentdescription img{padding:0 3px}
input#search_searchword{padding:2px}
table.searchintro{padding:10px 0; width:100%}
table.searchintro td{padding:5px!important}

.button, .validate{border:none; width:93px; height:23px; line-height:15px; text-align:center; margin:0; padding:2px 0 5px 0}
.back_button{padding:0 5px}
.readon{clear:both; height:23px; line-height:23px; display:inline-block; clear:both; text-align:center; width:93px; padding:0 0 0 0px; margin:10px 0 0 0}
.readon span{}
a.pagenav, 
.pagenav_prev a, 
.pagenav_next a, 
...
table.pollstableborder tr.sectiontableentry0 td{border:none; background:#1a1a1a}
table.pollstableborder tr.sectiontableentry1 td, 
table.pollstableborder tr.sectiontableentry2 td{border:none}
.sectiontableheader{border:1px solid #2a2a2a; background:#212121}
.sectiontableentry1{background-color:#212121}
tr.sectiontableentry0 td, tr.sectiontableentry1 td, tr.sectiontableentry2 td, 
td.sectiontableentry0, td.sectiontableentry1, td.sectiontableentry2{border-bottom:1px solid #2a2a2a}
tr.sectiontableentry0 td, td.sectiontableentry0, 
tr.sectiontableentry2 td, td.sectiontableentry2{background-color:#212121}
tr.sectiontableentry1 td, td.sectiontableentry1{background-color:#1a1a1a}
tr.sectiontableentry0:hover td, tr.sectiontableentry1:hover td, 
tr.sectiontableentry2:hover td{background-color:#282828}
...
.system-unpublished{background:#212121; border-top:1px solid #2a2a2a; border-bottom:1px solid #2a2a2a}

#system-message{margin:0 0px 10px 5px; padding:0}
#system-message dt{font-weight:bold}
#system-message dd{margin:0; font-weight:bold; text-indent:30px; background-image:none}
#system-message dd ul{ background-color:#212121; color:#c02; margin-bottom:10px; list-style:none; padding:10px; border-top:1px solid #2a2a2a; border-bottom:1px solid #2a2a2a}
...
#system-message dd.error ul{color:#c00; background-color:#212121; border-top:1px solid #2a2a2a; border-bottom:1px solid #2a2a2a}
#system-message dd.error ul li{background-image:none}

#system-message dt.notice{display:none}
#system-message dd.notice ul{color:#c00; background:#212121; border-top:1px solid #2a2a2a; border-bottom:1px solid #2a2a2a}
